...
export const metadata: Metadata = {
	title: "Jainam Bagrecha ",
	description:
		"Jainam Bagrecha's personal website. Software Engineer & FullStack Dev. Building web applications with Next.js,HonoJS, Tailwind CSS,Prisma and more.",
};
